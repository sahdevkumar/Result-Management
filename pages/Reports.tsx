    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
           {selectedStudentId ? (
              <div className="rounded-xl shadow-lg border border-slate-200 overflow-hidden print:shadow-none print:border-none print:w-full animate-in fade-in duration-300">
                  <div ref={reportRef} className="bg-white iso-bg">
